 ...
 */
package io.lh.seckill.interfaces.controller;

import io.lh.seckill.application.service.SeckillUserService;
import io.lh.seckill.domain.code.ErrorCode;
import io.lh.seckill.domain.model.SeckillUser;
import io.lh.seckill.domain.response.ResponseMessage;
import io.lh.seckill.domain.response.ResponseMessageBuilder;
